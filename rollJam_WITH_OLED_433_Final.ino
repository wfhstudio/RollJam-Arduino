...
void setup() 
{
  ...
  display.println("ROLL JAM RF 433.96");
  display.setCursor(12,20);
  display.println("WizzTech 2021-2022");
  display.display();
  delay(5000);
...
Serial.println("");
  ...
  display.setTextColor(WHITE);
  display.setCursor(12,8);
  display.println("Jammer initialized.");
  display.display();
  delay(1000);
setupReceiver(); 
...
replaySecond();
  ...
  { 
      ...
      display.setTextColor(WHITE);
      display.setCursor(12,8);
      display.println("Starting Jammer !!");
      display.display();
      while(jammin)
      {
         chipSelectRX = false;
  ...
  void replaySecond()
  {
      ...
      Serial.println("");
         ...
         display.setCursor(12,20);
         display.println("to send signal..!");
         display.display();
      ...
      for(int i=0; i < 3; i++)
      {
         Serial.println("Send received packets ! ");
         display.clearDisplay();
         display.setTextSize(1);
         display.setTextColor(WHITE);
         display.setCursor(12,8);
         display.println("Send received");
         display.setCursor(12,20);
         display.println("packets done ... !");
         display.display();
  ...
  void getData()
  {
    ...
    if(receivePacket(&packet) > 0)
    {
       if (packetCounter == 0)
       {
         ...
         display.setTextColor(WHITE);
         display.setCursor(12,8);
         display.println("Got one packet !");
         display.display();
         packetCounter++;
//         chip_reset();
//         setupReceiver();
       ...
       else if(packetCounter == 1)
       {
         ...
         display.setTextColor(WHITE);
         display.setCursor(12,20);
         display.println("Got second packet ! ");
         display.display();
         packetCounter = 0;
         }
       }
